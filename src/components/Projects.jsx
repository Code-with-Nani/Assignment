...
const Projects = () => {
  ...
  const arr2 =  [
    { src: img5, alt: "work - 1", para: "For: Zigoland, Project: started a new website from ground up for a new product details" },

    { src: img6, alt: "work - 2", para: "For: Visodream, Project: developed a new forum for the Visodream community details" },

    { src: img7, alt: "work - 3", para: "For: Primoday, Project: complete redesign of their corporate website and platform details" },

    { src: img8, alt: "work - 4", para: "For: Nextlite, Project: created a custom video editing and upload web app details" },

    { src: img9, alt: "work - 5", para: "For: Syncnow, Project: web design for their corporate websites and landing pages details" },

    { src: img10, alt: "work - 6", para: "For: Shifter, Project: started a new website from ground up for a new product details" },
  ]
    ...
    <>
...

        {
          arr.map((val) => (
            <div className="card flex flex-col justify-center items-center mx-4 my-10 ">
              ...
              <p className='roman  text-[17px] leading-[17px] pt-6 lg:w-[60%] text-left'>{val.para}</p>
            </div>
          ))
        }
      ...
      <div className="map2 mt-20 lg:grid grid-cols-3 lg:mx-60">
...

        {
          arr2.map((e) => (
            <div className="card flex flex-col justify-center items-center mx-4 my-10  ">
              <img className='select-none cursor-pointer rounded-2xl' src={e.src} alt={e.alt} />
              <p className='roman  text-[17px] leading-[17px] pt-6 text-center'>{e.para}</p>
            </div>
          ))
        }
